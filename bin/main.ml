...
let schema db_conn (config:Conf.Api_t.t) = Gql.Schema.(Schema.(schema [
...
let () =
  Core.Command.run @@ Lib.Config.(
    Cli.start_api_command Api_j.t_of_string (fun config ->
